...
class GXFastPreview {
    constructor() {
        this.studioIpAddress = "30.77.74.176";
    }
    startFastPreview() {
        Taro.connectSocket({
            ...
            task.onMessage((msg) => {
                ...
                if (data.method == 'template/didChangedNotification') {
                    ...
                    const templateJson = {};
                    const index_json = (_a = params.data['index.json']) === null || _a === void 0 ? void 0 : _a.trim();
                    const index_css = (_b = params.data['index.css']) === null || _b === void 0 ? void 0 : _b.trim();
                    const index_js = (_c = params.data['index.js']) === null || _c === void 0 ? void 0 : _c.trim();
                    const index_data_binding = (_d = params.data['index.databinding']) === null || _d === void 0 ? void 0 : _d.trim();
                    const index_mock = (_e = params.data['index.mock']) === null || _e === void 0 ? void 0 : _e.trim();
                    const index_data = (_f = params.data['index.data']) === null || _f === void 0 ? void 0 : _f.trim();
...
//# sourceMappingURL=GXFastPreview.js.map