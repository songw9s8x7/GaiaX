...
class GXExpression {
    constructor() {
        this.valueRegex = /\$\{[a-zA-Z.\[\]0-9]+\}/g;
        this.ternaryValueRegex = /\@\{/g;
    }
    desireData(expression, rawJson) {
...
//# sourceMappingURL=GXExpression.js.map